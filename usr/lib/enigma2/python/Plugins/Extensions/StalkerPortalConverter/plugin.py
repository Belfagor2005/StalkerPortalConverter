...
class StalkerPortalConverter(Screen):
    skin = """
        <screen name="StalkerPortalConverter" position="320,179" size="1280,720" title="Stalker Portal Converter" backgroundColor="#16000000">
            ...
            <eLabel name="" position="1070,670" size="52,40" backgroundColor="#00ffff" foregroundColor="#000000" halign="center" valign="center" transparent="0" cornerRadius="10" font="Regular; 17" zPosition="1" text="INFO" />
    ...
    def get_vod_list(self, portal, mac, token):
        """Retrieve complete VOD list with categories and movies"""
        vod_categories = []
        try:
            ...
            categories = self.get_vod_categories(portal, headers)
            ...
            for category in categories:
                ...
                movies = self.get_vod_movies(portal, category_id, headers)

                vod_entries = []
                for movie in movies:
                    # Get stream URL for each movie
                    stream_url = self.get_vod_stream_url(
                        portal,
                        movie.get("cmd", ""),
                        mac,
                        token
            ...
            print(f'Error getting complete VOD list: {str(e)}')
            return []
